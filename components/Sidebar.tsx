    ...
    return (
        <div className="w-[400px] p-6 flex flex-col justify-between h-full">
            <div className="space-y-4">
                ...
                <button onClick={() => router.push('/craze/explore')} className='px-8 py-4 text-3xl w-full font-outfit font-semibold bg-white text-pink-900 rounded-full shadow-lg cursor-pointer hover:scale-102'>Explore Animals</button>
                <div className='flex items-center gap-2 w-full justify-between'>
                    <div className='relative'>
                        <HomeButton className='left-0 top-0'/>
                    </div>
                    <button onClick={onInstructionClick} className='px-8 py-4 w-full text-3xl font-outfit font-semibold bg-white text-pink-900 rounded-full shadow-lg cursor-pointer hover:scale-102'>Instructions</button>
                </div>
            </div>
